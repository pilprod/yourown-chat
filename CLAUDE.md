...
3. `.ai/coding-policy.md`
4. `.ai/infrastructure-policy.md`
5. `.ai/helm-policy.md`
6. `.ai/licensing-policy.md`
7. `.ai/naming-policy.md`
8. `.ai/security-policy.md`
9. `.ai/observability-policy.md`
10. `.ai/release-policy.md`
11. `.ai/testing-policy.md`
12. `.ai/tool-use-policy.md`
13. `.ai/multi-agent-workflow.md`
14. The architecture or operations document relevant to the task
