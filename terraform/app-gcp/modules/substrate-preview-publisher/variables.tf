...
variable "release_version" {
  ...
  default     = "0.0.22-private.3"

  validation {
    condition     = var.release_version == "0.0.22-private.3"
    error_message = "The current private Substrate handoff is pinned to release coordinate 0.0.22-private.3."
  }
}
