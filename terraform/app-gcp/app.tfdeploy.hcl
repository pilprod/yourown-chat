...
deployment "eu" {
  inputs = {
    ...
    # profiles). Both remain off until the platform charts are published and
    # the owning service repositories carry reviewed release wrappers.
    wrapper_releases_enabled  = false
    chart_publication_enabled = false
