...
#
# Independence: Google APIs and the github-pat secret are provisioned once in
# docs/INIT.md, so this stack neither enables APIs nor manages the PAT secret --
# it can be applied in any order relative to the platform stack. See docs/BUILD.md.
# ---------------------------------------------------------------------------
