...
output "image_path" {
  description = "Full unified image path (no tag), e.g. europe-west3-docker.pkg.dev/PROJECT/yourown-chat-containers/mattermost. Reference this in the Mattermost manifests with the pushed tag (single tag, e.g. :v9.11.3-patched, promoted dev -> prod)."
